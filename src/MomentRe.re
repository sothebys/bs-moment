...
[@bs.module "moment"] external momentDefaultFormat: string => Moment.t = "default";

[@bs.module "moment"]
external momentWithFormat: (string, string) => Moment.t = "default";

[@bs.module "moment"] external momentWithDate: Js.Date.t => Moment.t = "default";

[@bs.module "moment"]
external momentWithFormats: (string, array(string)) => Moment.t = "default";

[@bs.module "moment"] external momentWithTimestampMS: float => Moment.t = "default";

[@bs.module "moment"] external momentWithComponents: list(int) => Moment.t = "default";
